...
- [ ] 6. Add raw body capture in app.js
  ...
  - [x]* 6.2 Write property test for raw body preservation
  ...
  - [x]* 6.3 Write unit test for empty body handling
...
- [ ] 8. Add rate limiting with express-rate-limit
  ...
  - [x]* 8.2 Write integration test for rate limiting
...
- [ ] 9. Implement validateSessionToken middleware
  ...
  - [x]* 9.2 Write property test for valid session token verification
  ...
  - [x]* 9.3 Write property test for invalid session token rejection
